...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->newToolStripButton->Click += gcnew System::EventHandler(this, &MyForm::ñòâîğèòèToolStripMenuItem_Click);
			// 
			// openToolStripButton
			// 
			...
			this->openToolStripButton->Click += gcnew System::EventHandler(this, &MyForm::â³äêğèòèToolStripMenuItem_Click);
			// 
			// saveToolStripButton
			// 
			...
			this->saveToolStripButton->Click += gcnew System::EventHandler(this, &MyForm::çáåğåãòèToolStripMenuItem_Click);
			// 
			...
			this->toolStripButton4->Text = L"Æèğíèé";
			...
			this->toolStripButton6->Text = L"Ï³äêğåñëåííÿ";
			...
			this->øğèôòToolStripMenuItem1->Size = System::Drawing::Size(167, 24);
...
private: System::Void helpToolStripButton_Click(System::Object^ sender, System::EventArgs^ e) {
	MessageBox::Show("Âèêîíàëà ñòóäåíòêà ãğóïè 3ÑÎÌ Òàğàíşê Íàä³ÿ", "Ïğî àâòîğà");
}
...
private: System::Void toolStripButton8_Click(System::Object^ sender, System::EventArgs^ e) {
	richTextBox1->Undo();
	toolStripStatusLabel1->Visible = true;
	toolStripStatusLabel1->Text = "Ïîâåğíóòè";
}
